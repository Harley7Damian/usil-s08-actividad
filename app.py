...
def get_mongo_collection():
    ...
    return db["pdf_vectors_peli_interstellar"]
...
with st.sidebar:
    ...
    st.write("Este chat utiliza un documento PDF especializado en la película Interstellar para responder preguntas relacionadas con su trama, análisis científico y fundamentos físicos y matemáticos.")
    st.markdown("* Interstellar")    
    st.markdown("---")
    st.write("El asistente puede proporcionar información sobre:")    
    st.markdown("* Director, reparto y producción de la película")
    st.markdown("* Resumen detallado de la trama")
    st.markdown("* Explicación de conceptos físicos y matemáticos")
    st.markdown("* Relatividad general y dilatación temporal")
    st.markdown("* Agujeros negros y agujeros de gusano")
    st.markdown("* Análisis del espacio-tiempo y la gravedad")
    st.markdown("* Explicación de las ecuaciones mencionadas en el documento")
    st.markdown("* Precisión científica de la película")
    st.markdown("* Interpretaciones filosóficas y científicas")
    st.markdown("* Relación entre ciencia real y ficción en Interstellar") 
    st.markdown("---")    
    st.subheader("Ejemplos rápidos") 
    st.write("* ¿Quién dirigió Interstellar?")
    st.write("* ¿Qué es Gargantúa en la película?")
    st.write("* Explica la dilatación temporal en el planeta Miller.")
    st.write("* ¿Qué significa la relatividad general en Interstellar?")
    st.write("* ¿Por qué una hora en Miller equivale a años en la Tierra?")
    st.write("* ¿Qué es un agujero de gusano?")
    st.write("* ¿Qué representa el teseracto al final de la película?")
    st.write("* ¿Qué tan científicamente precisa es Interstellar?")
    st.write("* ¿Quién fue Kip Thorne y cuál fue su participación en la película?")
    st.write("* Explica la ecuación de dilatación temporal mostrada en el PDF.")
